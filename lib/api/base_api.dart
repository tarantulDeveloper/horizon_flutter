...
class BaseApi extends ChangeNotifier{
  ...
  BaseApi() {
    ...
    Future<Response<dynamic>> sendRequest(
        String path,
        {dynamic data, Map<String, dynamic>? queryParameters, bool isMultipart = false})
    async {
      RequestOptions requestOptions = RequestOptions(path: path, data: data, queryParameters: queryParameters);
      if(isMultipart) {
